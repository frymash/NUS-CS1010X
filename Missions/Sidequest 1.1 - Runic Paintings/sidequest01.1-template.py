...
def egyptian(r,n):
    ...
    center_section = quarter_turn_left(stack_frac(1/n, rune_column, stack_frac(1 - (1/(n-1)), quarter_turn_right(r), rune_column)))
    
    return stack_frac(1/n, rune_row, stack_frac(1 - (1/(n-1)), center_section, rune_row))
    """
